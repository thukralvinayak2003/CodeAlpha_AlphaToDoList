...
exports.userTasks = exports.deleteUser = exports.getUser = exports.listUsers = void 0;
...
var getUser = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, db_server_1.db.user.findUnique({
                where: {
                    id: id,
                },
            })];
...
var deleteUser = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_server_1.db.user.delete({
                    where: {
                        id: id,
                    },
                })];
...
var userTasks = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, db_server_1.db.user.findUnique({
                where: {
                    id: id,
